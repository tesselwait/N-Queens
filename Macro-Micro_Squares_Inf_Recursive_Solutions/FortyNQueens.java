...
//40 * (5^x) nQueens solutions. Demonstrates running a recursively 
//expandable solution with a distinct base solution.
public class FortyNQueens {
	...
	public void stretchList() {
		int n = (int)(Math.pow(5,m));
		for(Coordinate b: forty)
			fortyTwo.add(new Coordinate((b.getY()*n)+n/2, (b.getX()*n)+n/2));
	}
	...
	public static void main(String[] args) {	
		FortyNQueens rl = new FortyNQueens(1);
		rl.runTest();
	}
}
